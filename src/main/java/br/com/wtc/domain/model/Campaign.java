...
public class Campaign {
    ...
    public Campaign(String id, String title, String body, String url,
                    List<Message.ActionButton> actions, Map<String, String> actionUrls, CampaignStatus status,
        ...
        this.actions = actions; this.actionUrls = actionUrls; this.status = status;
    ...
    public List<Message.ActionButton> getActions()  { return actions; }
    ...
    public void setActions(List<Message.ActionButton> actions)      { this.actions = actions; }
    ...
    public static class Builder {
        ...
        public Builder actions(List<Message.ActionButton> a){ this.actions = a; return this; }
        public Builder actionUrls(Map<String, String> a)       { this.actionUrls = a; return this; }
        public Builder status(CampaignStatus s)             { this.status = s; return this; }
        ...
        public Campaign build() {
            return new Campaign(id, title, body, url, actions, actionUrls, status,
