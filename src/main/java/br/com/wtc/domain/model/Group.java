...
public class Group {
    ...
    public Group(String id, String name, String description, String divisionId, List<String> clientIds, LocalDateTime createdAt) {
        this.id = id;
        this.name = name;
    ...
    public static class Builder {
        ...
        public Builder clientIds(List<String> c) {
            this.clientIds = c;
            return this;
        }
