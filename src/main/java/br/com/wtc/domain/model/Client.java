...
public class Client {
    ...
    public Client(String id, String name, String email, String phone, String status, int score, List<String> tags, String divisionId, String groupId, List<String> noteIds, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.id = id;
        this.name = name;
        this.email = email;
        this.phone = phone;
    ...
    public static class Builder {
        ...
        public Client build() {
            return new Client(id, name, email, phone, status, score, tags, divisionId, groupId, noteIds, createdAt, updatedAt);
        }
    }
}