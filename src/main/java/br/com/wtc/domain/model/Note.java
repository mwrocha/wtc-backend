...
public class Note {
    ...
    public Note(String id, String clientId, String operatorId,
                String content, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.id = id; this.clientId = clientId; this.operatorId = operatorId;
        this.content = content; this.createdAt = createdAt; this.updatedAt = updatedAt;
    }
    ...
    public static class Builder {
        ...
        public Builder operatorId(String o)         { this.operatorId = o; return this; }
