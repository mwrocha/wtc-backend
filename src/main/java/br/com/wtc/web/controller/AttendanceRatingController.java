...
public class AttendanceRatingController {
    ...
    public ResponseEntity<?> submitRating(
        ...
        try {
            ...
            AttendanceRating rating = ratingService.submitRating(
                    sessionId, userDetails.getUsername(), stars, comment);
    ...
    public ResponseEntity<?> getPending(
            @AuthenticationPrincipal UserDetails userDetails) {
        Map<String, String> pending = ratingService
                .getPendingRatingForClient(userDetails.getUsername());
